...
export const DialBeanLargeIcon = makeIcon("dial_bean_lg.svg", "DialBean Large");
export const DialBeanMediumIcon = makeIcon("dial_bean_md.svg", "DialBean Medium");
export const DialBeanSmallIcon = makeIcon("dial_bean_sm.svg", "DialBean Small");
export const EvaluationIcon = makeIcon("eval.svg", "Evaluation");
export const EvaluationSingleIcon = makeIcon("eval_single.svg", "Evaluation Single");
export const EvaluationAverageIcon = makeIcon("eval_avg.svg", "Evaluation Average");
